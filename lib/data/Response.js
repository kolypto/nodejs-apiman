 ...
 * Is used to report system errors throught the *System channel*
 * @param {ApiError?} err
 *      System error
 */
 ...
 * Use it if you don't want to deal with all this system/result channels logic: the two promises are combined.
 * When the resulting error is a system error, it gets a `system=true` property
